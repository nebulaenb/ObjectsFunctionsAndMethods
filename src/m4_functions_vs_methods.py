...
def try_methods():
    ...
    oliver = rg.SimpleTurtle()
    oliver.pen = rg.Pen('brown', 5)
    oliver.forward(150)
    oliver.left(90)
    oliver.forward(50)
    oliver.backward(100)
...
def try_methods_and_functions():
    ...
    """
    joye = rg.SimpleTurtle()
    joye.pen = rg.Pen('blue', 5)
    joye.backward(150)

    joye.speed = 1
    draw_many_squares(joye, 2, 100, 30)

    joye.speed = 5
    joye.pen.color = 'red'
    draw_many_squares(joye, 10, 50, 15)

    joye.speed = 100
    joye.pen.thickness = 35
    draw_many_squares(joye, 8, 300, 60)

    joye.pen = rg.Pen('black', 3)
